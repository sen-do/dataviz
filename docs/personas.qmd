...
![Sarah Thornton](pics/sarah.png){width=200px style="border-radius: 50%; float: left; margin-right: 20px; margin-bottom: 10px;"}
...
![Marcus Hoffmann](pics/marcus.png){width=200px style="border-radius: 50%; float: left; margin-right: 20px; margin-bottom: 10px;"}
